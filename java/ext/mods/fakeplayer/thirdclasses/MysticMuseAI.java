...
public class MysticMuseAI extends CombatAI implements IConsumableSpender, IPotionUser
{
	...
	protected List<OffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OffensiveSpell(1235));
		_offensiveSpells.add(new OffensiveSpell(1340));
		_offensiveSpells.add(new OffensiveSpell(1342));
		_offensiveSpells.add(new OffensiveSpell(1265));
