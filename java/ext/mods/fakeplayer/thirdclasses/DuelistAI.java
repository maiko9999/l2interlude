...
public class DuelistAI extends CombatAI implements IConsumableSpender, IPotionUser
{
	...
	protected List<OffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OffensiveSpell(345));
		_offensiveSpells.add(new OffensiveSpell(261));
		_offensiveSpells.add(new OffensiveSpell(5));
		_offensiveSpells.add(new OffensiveSpell(6));
		_offensiveSpells.add(new OffensiveSpell(1));
