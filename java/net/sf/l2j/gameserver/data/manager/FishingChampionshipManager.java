...
public class FishingChampionshipManager
{
		...
		for (Fisher fisher : _winPlayers)
		{
			if (fisher.getRewardType() != 2 && fisher.getName().equalsIgnoreCase(player.getName()))
			{
				...
				if (rewardCnt > 0)
				{
					...
					html.setFile(player.getLocale(), "html/fisherman/championship/fish_event_reward001.htm");
	...
	public void showMidResult(Player player)
	{
		...
		if (_needRefresh)
		{
			html.setFile(player.getLocale(), "html/fisherman/championship/fish_event003.htm");
			player.sendPacket(html);
		...
		html.setFile(player.getLocale(), "html/fisherman/championship/fish_event002.htm");
	...
	public void showChampScreen(Player player, int objectId)
	{
		...
		html.setFile(player.getLocale(), "html/fisherman/championship/fish_event001.htm");
