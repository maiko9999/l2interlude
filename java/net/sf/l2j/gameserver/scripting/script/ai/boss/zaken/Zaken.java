...
public class Zaken extends DefaultNpc
{
	...
	{
		if (called._i_ai0 == 0 && called.getAI().getCurrentIntention().getType() == IntentionType.WANDER && damage < 10 && GameTimeTaskManager.getInstance().getGameHour() < 5 && Rnd.get((30 * 15)) < 1)
		{
			called._i_ai0 = 0;
