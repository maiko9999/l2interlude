...
public class Q401_PathToAWarrior extends Quest
{
	...
	private static final int BIND_POISON_SPIDER = 20043;
	...
	public Q401_PathToAWarrior()
	{
		...
		addMyDying(TRACKER_SKELETON, POISON_SPIDER, TRACKER_SKELETON_LEADER, BIND_POISON_SPIDER);
	}
	...
	public void onMyDying(Npc npc, Creature killer)
	{
		...
		switch (npc.getNpcId())
		{
			case TRACKER_SKELETON, TRACKER_SKELETON_LEADER:
				if (st.getCond() == 2 && dropItems(player, RUSTED_BRONZE_SWORD_1, 1, 10, 400000))
					st.setCond(3);
				break;
			
			case POISON_SPIDER, BIND_POISON_SPIDER:
