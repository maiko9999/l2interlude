...
public class defence extends AbstractTableModel
{
	...
	public Object getValueAt(int row, int col)
	{
	    ...
	    return switch (col)
	    {
	        ...
	        case 2 -> r._modifier._pDefMod;
	        case 3 -> r._modifier._mDefMod;
	        default -> null;
	    };
	}
	...
	public void setValueAt(Object value, int row, int col)
	{
	    ...
	    try
	    {
	        ...
	        switch (col)
	        {
	            case 2 -> r._modifier._pDefMod = val;
	            case 3 -> r._modifier._mDefMod = val;
	        }
