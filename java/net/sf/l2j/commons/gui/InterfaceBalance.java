...
public class InterfaceBalance
{
	...
	public InterfaceBalance()
	{
		try
		{
			...
			UIManager.put("control", new Color(40, 40, 40)); // fundo de painéis e botões
			UIManager.put("info", new Color(60, 63, 65)); // tooltips, etc.
			UIManager.put("nimbusBase", new Color(30, 30, 30)); // base do Nimbus
			UIManager.put("nimbusBlueGrey", new Color(70, 73, 75)); // menus, bordas
			UIManager.put("nimbusLightBackground", new Color(30, 30, 30)); // fundo da janela
			UIManager.put("text", new Color(220, 220, 220)); // texto principal
